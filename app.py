...
body{font-family:'Inter',sans-serif;background:#0a0a0f;min-height:100vh;display:flex;align-items:center;justify-content:center;padding:24px}
.wrap{width:100%;max-width:400px}
.brand{text-align:center;margin-bottom:36px}
.icon{width:54px;height:54px;background:linear-gradient(135deg,#6366f1,#8b5cf6);border-radius:16px;display:flex;align-items:center;justify-content:center;margin:0 auto 12px;font-size:22px}
...
.pre{position:absolute;left:15px;top:50%;transform:translateY(-50%);color:#44445a;font-size:14px;pointer-events:none}
input[type=tel]{width:100%;padding:14px 14px 14px 46px;background:#0c0c18;border:1.5px solid #1e1e30;border-radius:12px;color:#fff;font-size:15px;font-family:'Inter',sans-serif;outline:none;transition:border-color .2s}
input[type=tel]:focus{border-color:#6366f1}
input[type=tel]::placeholder{color:#333}
button{width:100%;padding:14px;background:linear-gradient(135deg,#6366f1,#8b5cf6);color:#fff;border:none;border-radius:12px;font-size:14px;font-weight:600;font-family:'Inter',sans-serif;cursor:pointer;transition:opacity .2s}
button:hover{opacity:.88}
.ab{text-align:center}
.check{width:60px;height:60px;background:linear-gradient(135deg,#10b981,#059669);border-radius:50%;display:flex;align-items:center;justify-content:center;margin:0 auto 18px;font-size:26px}
...
.pulse{display:inline-flex;align-items:center;gap:6px;background:#0b1a12;border:1px solid #064e35;border-radius:20px;padding:5px 13px;font-size:11px;color:#10b981;font-weight:500}
...
.reset{display:block;margin-top:14px;text-align:center;font-size:11px;color:#2a2a3a;text-decoration:none;transition:color .2s}
...
def reset():
    ...
    target_phone = ""; sms_count = 0; last_status = ""
    return redirect(url_for("index"))
